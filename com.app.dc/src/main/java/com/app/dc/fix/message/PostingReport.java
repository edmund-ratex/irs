...
public class PostingReport extends FixMessage{
		public PostingReport()
		{		 
			this.getStandardHeader().setMsgType("PO");
		}
		public String getID(){
			return DataTypeConverter.Utils.toString(this.get(MessageDictionary.Fields.ID));
		}
		public void setID(String iD){
			this.put(MessageDictionary.Fields.ID, iD);
		}
		...
		public String getSource(){
			return DataTypeConverter.Utils.toString(this.get(MessageDictionary.Fields.Source));
		}
		public void setSource(String source){
			this.put(MessageDictionary.Fields.Source, source);
		}
		public String getSourceID(){
			return DataTypeConverter.Utils.toString(this.get(MessageDictionary.Fields.SourceID));
		}
		public void setSourceID(String sourceID){
			this.put(MessageDictionary.Fields.SourceID, sourceID);
		}
	...
	public PostingReport Clone()
	{
		PostingReport t=new PostingReport();
		...
		t.setSource(getSource());
		t.setSourceID(getSourceID());
